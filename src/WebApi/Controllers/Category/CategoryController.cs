...
//         }
//
//         Models.CategoryEntity category = _mapper.Map<Models.CategoryEntity>(request);
...
//         }
//
//         Models.CategoryEntity? existingCategory = await _context.Categories.FirstOrDefaultAsync(x => x.Id == id);
